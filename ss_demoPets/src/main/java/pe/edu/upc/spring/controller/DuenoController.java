...
public class DuenoController {
	...
	public String irPaginaListadoRazas(Map<String, Object> model) {
		model.put("listaRazas", dService.listar());
		return "listDueno";
	}
	...
	public String registrar(@ModelAttribute Dueno objDueno, BindingResult binRes, Model model) throws ParseException {
		if (binRes.hasErrors())
			return "dueno";
		else {
			boolean flag = dService.insertar(objDueno);
			if (flag)
	...
	public String modificar(@PathVariable int id, Model model, RedirectAttributes objRedir) throws ParseException {
		Optional<Dueno> objDueno = dService.listarId(id);
		if (objDueno == null) {
